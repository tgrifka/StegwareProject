...
if __name__ == '__main__':
    ...
    """
    The First AI trained will be our base case, it will be trained on all 4 types of images we have
    """

    # reads in dataset
    data_dir = 'D:\Stegware\FeatureTesting'
...
#  ---------------------------------------------------------------------------------------------------------------------
    """
    The Second AI is trained only on Cover and JMiPOD
    """
    # reads in dataset
    data_dir = 'D:\Stegware\FeatureTesting' # changes this
    data_dir = pathlib.Path(data_dir)
    image_count = len(list(data_dir.glob('*/*.jpg')))
    print(image_count)
    ...
    checkpoint_path = 'D:\Stegware\StegwareProject\\training_checkpoints\\1' # change this
    checkpoint_dir = os.path.dirname(checkpoint_path)
...
#  ---------------------------------------------------------------------------------------------------------------------
    """
        The Third AI is trained only on Cover and JUNIWARD
    """
    # reads in dataset
    data_dir = 'D:\Stegware\FeatureTesting'  # changes this
    data_dir = pathlib.Path(data_dir)
...
#  ---------------------------------------------------------------------------------------------------------------------
    """
        The Third AI is trained only on Cover and UERD
    """
    # reads in dataset
    data_dir = 'D:\Stegware\FeatureTesting'  # changes this
    data_dir = pathlib.Path(data_dir)
